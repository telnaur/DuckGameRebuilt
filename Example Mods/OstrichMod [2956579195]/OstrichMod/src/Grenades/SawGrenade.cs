...
namespace DuckGame.OstrichMod
{
    ...
    class SawGrenade : Gun
    {
        ...
        public SawGrenade(float xval, float yval) : base(xval, yval)
        {
            this._editorName = "SawGrenade";
            this.ammo = 1;
            this._ammoType = new ATAeres();
            this._type = "gun";
            this._sprite = new SpriteMap(Mod.GetPath<DuckGame.OstrichMod.OstrichMod>("SawGrenade"), 16, 16);
