...
namespace MyMod.src
{
    public class potionSmoke : Thing
    {
        ...
        public potionSmoke(float xpos, float ypos)
          : base(xpos, ypos, (Sprite)null)
        {
            this.xscale = 0.08f + Rando.Float(0.1f);
