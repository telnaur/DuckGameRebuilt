...
namespace MyMod.src
{
    ...
    public class redEyeFlower : Thing
    {
        ...
        */
        ...
        public redEyeFlower(float xpos, float ypos)
          : base(xpos, ypos, (Sprite)null)
        {
            this._sprite = new SpriteMap(GetPath("redEyeFlower"), 10, 28, false);
        ...
        public override void Update()
        {
            ...
            if (this._sprite.frame == 7 && klatka == false)
            {
                ...
                if (this.isServerForObject)
                {
                    ...
                    redEyeEye eyeEye = new redEyeEye(this.x + 0.5f, this.y -21.5f);
