...
namespace MyMod.src
{
    ...
    public class greySpring : Holdable, IPlatform
    {
        ...
        public greySpring(float xpos, float ypos, float mult = 1f)
          : base(xpos, ypos)
        {
            this._sprite = new SpriteMap(GetPath("greySpring"), 16, 16, false);
            ...
            this._mult = mult;
            this._editorName = "Spring Box";
            this.editorTooltip = "The child of a trampoline and a crate. Very weird situation must have lead to this.";
        }
