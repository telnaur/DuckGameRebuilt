...
namespace DuckGame.DeathcratesPlusPlus
{
    ...
    class DoomBottomCrate : DeathCrate
    {
        ...
        public DoomBottomCrate(float xpos, float ypos) : base(xpos, ypos)
        {
            this._editorName = "Bottom Doom Crate";
            this._sprite = new SpriteMap(Mod.GetPath<DeathcratesPlusPlus>("crates\\bottomdoomcrate"), 16, 19, false);
