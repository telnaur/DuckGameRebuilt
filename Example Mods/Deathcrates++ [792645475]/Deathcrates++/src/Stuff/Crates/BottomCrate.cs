...
namespace DuckGame.DeathcratesPlusPlus
{
    ...
    class BottomCrate : DeathCrate
    {

        private SpriteMap _sprite;
        private bool _didActivation = false;

        public BottomCrate(float xpos, float ypos) : base(xpos, ypos)
        {
            this._editorName = "Bottom Crate";
            this._sprite = new SpriteMap(Mod.GetPath<DeathcratesPlusPlus>("crates\\bottomcrate"), 16, 19, false);
