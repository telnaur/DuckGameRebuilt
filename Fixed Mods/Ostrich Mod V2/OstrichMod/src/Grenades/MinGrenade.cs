...
namespace DuckGame.OstrichMod
{
    ...
    class MinGrenade : Gun
    {
        ...
        public MinGrenade(float xval, float yval) : base(xval, yval)
        {
            this._editorName = "MinGrenade";
            this.ammo = 1;
            this._ammoType = new ATMin();
            this._type = "gun";
            this._sprite = new SpriteMap(Mod.GetPath<DuckGame.OstrichMod.OstrichMod>("MinGrenade"), 16, 16);
