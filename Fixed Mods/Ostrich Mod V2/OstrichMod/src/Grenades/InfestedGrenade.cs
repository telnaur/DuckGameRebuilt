...
namespace DuckGame.OstrichMod
{
    ...
    class InfestedGrenade : Gun
    {
        ...
        public InfestedGrenade(float xval, float yval) : base(xval, yval)
        {
            this._editorName = "Infested Grenade";
            this.ammo = 1;
            this._ammoType = new ATMin();
            this._type = "gun";
            this._sprite = new SpriteMap(Mod.GetPath<DuckGame.OstrichMod.OstrichMod>("InfestedGrenade"), 16, 16);
        ...
        public override void Update()
        {
            ...
            {
                Level.Add(new NarcoticSmoke(x, y, 2.5f + Rando.Float(1f)));
                Level.Add(new NarcoticSmoke(x, y + 25, 2.5f + Rando.Float(1f)));
                Level.Add(new NarcoticSmoke(x, y - 25, 2.5f + Rando.Float(1f)));
                Level.Add(new NarcoticSmoke(x + 25, y, 2.5f + Rando.Float(1f)));
                Level.Add(new NarcoticSmoke(x - 25, y, 2.5f + Rando.Float(1f)));
                Level.Remove((this));
            }
        }
