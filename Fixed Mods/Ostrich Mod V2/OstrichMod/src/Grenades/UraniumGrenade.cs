...
namespace DuckGame.OstrichMod
{
    ...
    class UraniumGrenade : Gun
    {
        ...
        public UraniumGrenade(float xval, float yval) : base(xval, yval)
        {
            this._editorName = "UraniumGrenade";
            this.ammo = 1;
            this._ammoType = new ATReboundLaser();
            this._type = "gun";
            this._sprite = new SpriteMap(Mod.GetPath<DuckGame.OstrichMod.OstrichMod>("UraniumGrenade"), 16, 16);
