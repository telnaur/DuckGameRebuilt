...
namespace DuckGame.OstrichMod
{
    ...
    class RobloxGun : Gun
    {
        ...
        public RobloxGun(float xval, float yval) : base(xval, yval)
        {
            this._editorName = "RobloxGun";
            this.ammo = 3;
            this._ammoType = new ATUff();
            this._type = "gun";
            this._fullAuto = false;
            this.sprite = new SpriteMap(Mod.GetPath<DuckGame.OstrichMod.OstrichMod>("Roblox"),54, 20);
            ...
            this._fireSound = GetPath("SFX/UffSound");
            this.weight = 5f;
