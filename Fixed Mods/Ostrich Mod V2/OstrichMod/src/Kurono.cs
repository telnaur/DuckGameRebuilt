...
namespace DuckGame.OstrichMod
{
    ...
    public class Kurono : Gun
    {
        ...
        public Kurono(float xval, float yval)
        : base(xval, yval)
        {
            base.ammo = 4;
            base._ammoType = new ATMele();
            base._ammoType.range = 170f;
            base._ammoType.accuracy = 0.8f;
            base._type = "gun";
            base._holdOffset = new Vec2(0f, 0f);
            _sprite = new SpriteMap(GetPath("Kurono"), 16, 41);
            ...
            graphic = _sprite;
            center = new Vec2(7f, 37f);
            collisionOffset = new Vec2(-7f, -37f);
            collisionSize = new Vec2(16f, 41f);
            base._barrelOffsetTL = new Vec2(30f, 30f);
        ...
        {
            float bulletAngle = (int)offDir >= 0 ? angleDegrees + _ammoType.barrelAngleDegrees + 35 : angleDegrees + 180f - _ammoType.barrelAngleDegrees - 35;
