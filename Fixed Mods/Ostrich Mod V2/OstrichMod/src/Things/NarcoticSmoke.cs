...
{
    public class NarcoticSmoke : Thing
    {
        public float Timer {
            get;
            set;
        ...
        public NarcoticSmoke(float xval, float yval, float stayTime = 1f) : base(xval, yval)
        {
        ...
        public virtual void ToxicOnDucks()
        {
            ...
            {
                Level.Add(new StunHandler(duck, 1, showDaze: true));
            }
        }
    }
}
