...
namespace DuckGame.OstrichMod
{
    ...
    class EternalOS : Gun
    {
        ...
        public EternalOS(float xval, float yval) : base(xval, yval)
        {
            this._editorName = "EternalOS";
            this.ammo = 999;
            this._ammoType = (AmmoType)new ATOS();
            this._fullAuto = true;
            this.sprite = new SpriteMap(Mod.GetPath<DuckGame.OstrichMod.OstrichMod>("EternalOS"),54, 20);
